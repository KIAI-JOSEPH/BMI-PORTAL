  ...
  const schema: Record<string, CollectionSchema> = {
    ...
    grade_appeals: {
      fields: {
        ...
        status: { type: 'select', options: { values: ['Pending', 'Under Review', 'Approved', 'Denied', 'Withdrawn'], maxSelect: 1 } },
    ...
    grading_scales: {
      fields: {
        name: { type: 'text', required: true },
        description: { type: 'text' },
        scale_data: { type: 'json', required: true, options: { maxSize: 2000000 } },
    ...
    hostels: {
      fields: {
        name: { type: 'text', required: true },
        type: { type: 'select', required: true, options: { values: ['Male', 'Female'], maxSelect: 1 } },
        capacity: { type: 'number', required: true },
        location: { type: 'text', required: true },
        status: { type: 'select', required: true, options: { values: ['Available', 'Near Capacity', 'Full'], maxSelect: 1 } },
      }
    },
    room_assignments: {
      fields: {
        ...
        hostelId: { type: 'relation', required: true, options: { collectionId: 'hostels', maxSelect: 1 } },
        roomNumber: { type: 'text', required: true },
        checkInDate: { type: 'text', required: true },
        status: { type: 'select', required: true, options: { values: ['Active', 'Revoked'], maxSelect: 1 } },
      }
    },
    medical_visits: {
      fields: {
        ...
        status: { type: 'select', required: true, options: { values: ['Normal', 'Urgent', 'Follow-up'], maxSelect: 1 } },
    ...
    inventory_items: {
      fields: {
        ...
        condition: { type: 'select', required: true, options: { values: ['New', 'Good', 'Fair', 'Poor'], maxSelect: 1 } },
        location: { type: 'text', required: true },
    ...
    visitors: {
      fields: {
        ...
        checkOut: { type: 'text' },
        status: { type: 'select', required: true, options: { values: ['Active', 'Checked Out'], maxSelect: 1 } },
      }
    },
    attendance_records: {
      fields: {
        ...
        date: { type: 'text', required: true },
        records: { type: 'json', required: true, options: { maxSize: 2000000 } },
      }
    }
  };
