...
const STUDENTS: StudentRow[] = [
  ...
  ...Array.from({ length: 16 }, (_, i) => {
    ...
    return {
      ...
      grades: [
        {course_slug:'hom121',total_score:base+7},
        {course_slug:'her114',total_score:base+4},
        {course_slug:'pne126',total_score:base+9},
        {course_slug:'eva115',total_score:base+12},
        {course_slug:'esc221',total_score:base+2},
        {course_slug:'nts112',total_score:base+8},
        {course_slug:'ots111',total_score:base+5},
        {course_slug:'bib113',total_score:base+14},
        {course_slug:'chh122',total_score:base+6},
        {course_slug:'spw224',total_score:base+1},
        {course_slug:'pce227',total_score:base+10},
      ],
    };
  }),
];
