...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ryqmhyco")

  // remove
  collection.schema.removeField("hzg8tghw")

  // remove
  collection.schema.removeField("g17hpvog")

  // remove
  collection.schema.removeField("hlwbqqls")

  // remove
  collection.schema.removeField("krpuoavp")
