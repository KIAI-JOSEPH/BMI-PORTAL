...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("4ehtvgcv")

  // remove
  collection.schema.removeField("g3elxxxv")

  // remove
  collection.schema.removeField("vquskypa")

  // remove
  collection.schema.removeField("yaxm1gwe")
