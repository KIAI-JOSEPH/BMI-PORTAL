...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("pzcwphkq")

  // remove
  collection.schema.removeField("dgozdxug")

  // remove
  collection.schema.removeField("9dpsw9kz")

  // remove
  collection.schema.removeField("gyz0kp7r")

  // remove
  collection.schema.removeField("axllo2jq")

  // remove
  collection.schema.removeField("rowt7egu")

  // remove
  collection.schema.removeField("pcxpxord")
