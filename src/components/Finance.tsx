    ...
    <div className="h-full flex flex-col animate-fade-in relative">
      ...
      <div className="flex-shrink-0 sticky top-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 px-4 py-2 flex flex-col md:flex-row justify-between items-center gap-2 shadow-sm min-h-[60px]">
        <div className="flex items-center gap-3 pl-14 w-full md:w-auto">
           ...
           <div className="flex flex-col">
              <h2 className="text-base md:text-lg font-bold text-[#2E004F] dark:text-white tracking-tight uppercase leading-none">Department of Finance</h2>
              <p className="text-[8px] md:text-[9px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-widest">BMI Institutional Finance & Audit Ledger</p>
           </div>
        </div>
        <div className="flex gap-3 pl-14 md:pl-0 w-full md:w-auto justify-end">
          ...
          >
            <Plus size={12} className="text-[#FFD700]" /> {financeView === 'students' ? 'Record Payment' : 'Process Payroll'}
          </button>
        </div>
      </div>
      ...
      <div className="sticky top-[60px] z-30 bg-[#F8F9FA]/95 dark:bg-[#0a0015]/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-6 py-3 flex items-center gap-3 overflow-x-auto no-scrollbar shadow-sm">
         <div className="flex items-center gap-2 mr-4 text-gray-400">
            <CreditCard size={14} />
            <span className="text-[9px] font-black uppercase tracking-widest">Ledgers</span>
         </div>
         <button 
          ...
          >
            <Users size={12} className={financeView === 'students' ? 'text-[#FFD700]' : 'text-gray-400'} /> Student Ledger
          </button>
          <button 
          ...
          >
            <Briefcase size={12} className={financeView === 'employees' ? 'text-[#FFD700]' : 'text-gray-400'} /> Personnel Payroll
          </button>
      </div>
